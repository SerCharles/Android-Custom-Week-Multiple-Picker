...
public class PickerView extends FrameLayout implements View.OnClickListener {
    private static final String LOG_TAG = PickerView.class.getSimpleName();
    ...
    public interface OnWeeksSelectionChangedListener {
         ...
         * set as true
         */
        void onWeeksSelectionChange(PickerView pickerView, ArrayList<Integer> selectedWeeks);
    }

    @RequiresApi(api = Build.VERSION_CODES.M)
    public PickerView(@NonNull Context context) {
        super(context);
        LayoutInflater.from(getContext()).inflate(R.layout.layout_picker_view,
                this,
                true);    }
